                ...
                children: [
                    ...
                    child: Obx(() {
                      return Row(
                        children: List.generate(
                          ...
                          (index) {
                            final isSelected =
                                searchController.selectedIndex.value == index;
                            return Padding(
                              ...
                              child: GestureDetector(
                                ...
                                child: AnimatedContainer(
                                  ...
                                  child: Text(
                                    searchController.categories[index],
                                    style: GoogleFonts.poppins(
                  ...
                  Expanded(
                    child: ListView.builder(
                      itemCount: homeController.msStock.length - 1,
                      itemBuilder: (context, index) {
                        final filteredStocks = homeController.msStock
                            .where((stock) => stock.ticker != 'IHSG')
                            .toList();
