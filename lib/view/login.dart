...
import 'package:stocklyzer/controller/loginController.dart';
      ...
      body: Obx(() {
        return Stack(
          children: [
            ...
            if (loginController.isLoading.value) OverlayLoading(),
          ],
        );
      }),
    );
